use utf8;
package PgDB::Schema::Result::CDomain;
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6qVX5IiVUdJ00gn1NqKQyQ
# These lines were loaded from './PgDB/Schema/Result/CDomain.pm' found in @INC.
